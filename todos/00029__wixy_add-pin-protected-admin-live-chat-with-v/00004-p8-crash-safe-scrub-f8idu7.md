...
- Latest evidence after both medium fixes: affected backend store/janitor/routes/media-queue slice 140/140 passed; Ruff check/format passed; mypy passed across 206 sources. The prior candidate also passed Admin Vitest 1,095, strict typecheck, and P8 Server chat Playwright 7/7. The medium changes do not touch the frontend.
