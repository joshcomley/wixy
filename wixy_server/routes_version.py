...
reachable even before any Access app is provisioned (milestone 11)."""
...
def _build_version(wixy_repo_root: Path, paths: ProjectPaths) -> dict[str, object]:
    ...
    return {
        ...
        "slot": None,  # not Slots-deployed yet — milestone 11
...
async def get_version(request: Request) -> dict[str, object]:
    ...
    return await anyio.to_thread.run_sync(_build_version, wixy_repo_root, paths)
